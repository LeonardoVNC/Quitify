        ...
        when(categoria){
            ...
            "Aprendizaje" -> {
                list = mutableListOf(
                    ...
                    Actividad(titulo = "Investiga un dato curioso historico", descripcion = "Elige un evento histórico o personaje famoso, talvez ya tienes un favortio, y descubre un hecho interesante sobre él. Anótalo y compártelo con alguien.","Dato curioso","https://blog.3bee.com/es/tassodelmiele-3bee-es/"),
